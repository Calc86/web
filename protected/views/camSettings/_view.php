...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('stop_width')); ?>:</b>
	<?php echo CHtml::encode($data->stop_width); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('stop_height')); ?>:</b>
	<?php echo CHtml::encode($data->stop_height); ?>
	<br />
